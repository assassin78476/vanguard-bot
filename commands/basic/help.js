...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const BOT_ICON = "https://media.discordapp.net/attachments/1397077990579372126/1416442022457249873/ChatGPT_Image_7_sept._2025_17_20_16.png?ex=68c6dbee&is=68c58a6e&hm=de1ad7a0707763d0a978ffdbdaeacbad793dda82409e2901dae6525856afab9d&=&format=webp&quality=lossless&width=795&height=795";
            const EMBED_COLOR = "#5865F2"; 
            const FOOTER_TEXT = "Vanguard | The Discord Operating System • Created by Sentinel Developement";
            ...
            const createPages = (commandSet, type) => {
                ...
                pages.push({
                    ...
                    author: { name: 'VANGUARD • COMMAND CENTER' },
                    icon: '📚'
                });
            ...
            const createEmbed = () => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setAuthor({
                        ...
                        iconURL: BOT_ICON,
                        url: "https://discord.gg/TackVJ6Wqb"
                    })
                    .setImage(helpBanner)
